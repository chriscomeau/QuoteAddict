...
- (NSString*)twitterConsumerKey {
    return @"LBqb2WcEeLFODmue7KkfA"; //quote
    //return @""; //empty
}

- (NSString*)twitterSecret {
    return @"GQsXbRiVByf447ID7L18xTcQVCNyF9PyS8UgkXeWZh4"; //quote
	//return @""; //empty
}
