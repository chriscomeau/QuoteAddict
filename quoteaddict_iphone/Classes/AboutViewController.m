...
- (void)viewDidLoad {
    ...
    //image = [QREncoder encode:@"http://itunes.apple.com/app/id580936901"];
    ...
    //google charts
    /*NSURL *imageURL = [NSURL URLWithString:@"http://chart.apis.google.com/chart?cht=qr&chs=200x200&chl=http://itunes.apple.com/app/id580936901"];
...
{
    NSLog(@"statusBarWillChangeFrame");
...
{
    NSString *textToShare = @"Check out Quote Addict for iOS!";
    NSURL *url = [NSURL URLWithString:@"http://itunes.apple.com/app/id580936901"];
    NSString *subject = @"Quote Addict for iOS";
    ...
    */
    ...
    else
    {
            ...
            actionSheetTwitter.cancelButtonIndex = actionSheetTwitter.numberOfButtons - 1;
             ...
             if([appDelegate isIpad])
            {
                actionSheetTwitter.actionSheetStyle = UIActionSheetStyleBlackTranslucent;
                [actionSheetTwitter showFromRect:[sender frame] inView:self.view animated:YES];
            }
            else
            {
                actionSheetTwitter.actionSheetStyle = UIActionSheetStyleBlackTranslucent;
    ...
    //if(alertView == alertEmail)
    {
        ...
        else if(buttonIndex==1)
        {
           ...
           //                       [[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleShortVersionString"] ];
            ...
            [appDelegate sendEmailTo:@"info@skyriser.com" withSubject: @"Quote Addict iOS Feedback" withBody:body withView:self];
...
- (void)actionVersion:(id)sender
{
	...
	[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"http://quoteaddict.com/changelog.php"]];
}
           ...
           //otherButtonTitles: @"Email", @"Text Message", @"QR Code",/* @"Gift App"*/, @"Facebook", @"Twitter",
            ...
            switch (buttonIndex) 
            {
                case 0:
                    ...
                    {
                        [appDelegate sendEmailTo:@"" withSubject: @"Quote Addict for iOS" withBody:@"Check out this application:\n\nhttp://itunes.apple.com/app/id580936901" withView:self];
                    }
                    else
                ...
                case 1:
                    ...
                    {
                        NSString *descString = [NSString stringWithFormat:@"Check out this application: Quote Addict for iOS: %@", urlString];          
