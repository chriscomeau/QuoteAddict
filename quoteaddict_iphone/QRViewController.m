...
- (void)viewDidLoad {
    ...
    //google charts
    /*NSURL *imageURL = [NSURL URLWithString:@"http://chart.apis.google.com/chart?cht=qr&chs=200x200&chl=http://itunes.apple.com/app/id580936901580936901"];
...
{
	//QuoteAddictAppDelegate *appDelegate = (QuoteAddictAppDelegate *)[[UIApplication sharedApplication] delegate];
